        ...
        <footer className="flex flex-col">
            <div className="h-[150px] flex justify-evenly items-center py-4 bg-[#ff4a4a]
                ...
                <div className="flex flex-col justify-start">
                    {option.map(each => 
                        <Anchor 
                            key={each.to}
                            to={each.to} 
                            className="text-[#fefefe] text-[12px] pb-1 hover:text-black
                                        md:text-[16px]
                ...
                <div className="flex flex-col justify-center">
                    ...
                    >
                        ...
                        <li>
                            <a href="https://wa.me/5492612472047" rel="noreferrer" target="_blank">
                            <svg 
                            xmlns="http://www.w3.org/2000/svg" 
                            viewBox="0 0 448 512"
                            className="fill-[#fefefe] mb-2 hover:fill-black"
            ...
            <div className="h-[30px] bg-black flex justify-center">
                <p className="text-[10px] text-[#fefefe] self-center
                            md:text-[12px]">
                    &copy; 2024 Nikkei Mendoza - Todos los derechos reservados.
                </p>
            </div>
        </footer>
    )
