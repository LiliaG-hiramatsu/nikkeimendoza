export default function Home() {
    return (
        <main className="grow flex flex-col items-center">
            <div className="w-full h-screen bg-cover bg-center bg-[url('/data/portada-movil.jpg')] relative opacity-75
            ...
            <div className="w-3/5 flex flex-col my-6 text-[#333] text-justify">
                <div className="my-5">
                ...
                <div className="my-5">
                    <h2 className="text-[13px] self-start mb-1
                        md:text-[16px]
                        lg:text-[24px]">Objetivos de la asociación:</h2>
